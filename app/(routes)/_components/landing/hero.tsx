...
<section className="landing-hero-bg  w-full">
      <div className="w-full min-h-[85vh] max-w-screen-2xl mx-auto md:min-h-lvh flex items-center responsive-padding">
      <div className="flex flex-col space-y-8 md:-mt-6 ">
