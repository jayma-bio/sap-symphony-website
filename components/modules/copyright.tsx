...
const CopyRight = () => {
  return (
    <div className="w-full mx-auto max-w-screen-2xl flex items-center justify-between responsive-padding py-2 text-xs md:text-sm text-deep-gray bg-light-white">
